...
Layer 3 — Combinators (domain-agnostic):
  interaction, split_by, threshold, log_transform,
...
LAYER3_COMBINATORS = ["interaction", "split_by", "threshold", "log_transform", "ratio", "power", "difference"]
...
UNARY_COMBINATORS = {"log_transform", "threshold", "power"}
